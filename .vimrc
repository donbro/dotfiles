...
tabstop=4       " ts  A four-space tab indent width is the prefered coding style for Python (and everything else!), 
...
smarttab    "     sta Use the "shiftwidth" setting for inserting <TAB>s instead of the "tabstop" setting, 
...
softtabstop=4   "    sts People like using real tab character instead of spaces because it makes it easier when pressing BACKSPACE or DELETE, 
...
autoindent  "   ai  Very painful to live without this (especially with Python)! 
